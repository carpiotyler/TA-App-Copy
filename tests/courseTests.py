...
class CourseTest(unittest.TestCase):
    ...
    def test_course_add(self):
        ...
        self.assertEquals("Successfully Added Course",self.c.add(dept='CS',cnum='359',ta='Jason'))
        self.assertEquals("Successfully Added Course",self.c.add(dept='CS',cnum='359'))
    ...
    def test_course_edit(self):
        ...
        self.assertEquals("CS-351, TA: None \nCS-341, TA: Alice \nCS-331, TA: Yang",self.c.view())
